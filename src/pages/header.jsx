        ...
        <header className="body-font bg-purple-main text-gray-600">
          <div className="container mx-auto flex flex-col flex-wrap items-center pt-5 pl-7 lg:pl-0 md:flex-row">
            <a className="title-font mb-4 flex items-center font-medium text-gray-900 md:mb-0">
              ...
              <span className="ml-1 text-xl font-semibold">NFT Pocket Assistant - launching July</span>
            </a>
            <nav className="flex flex-wrap items-center justify-center text-base md:ml-auto">
              <a className="mt-4 inline-flex items-center rounded-lg bg-purple-box py-2 px-3 text-base font-bold text-white hover:bg-purple-box/80 focus:outline-none md:mt-0 mr-4" target="_blank" rel="noreferrer">
