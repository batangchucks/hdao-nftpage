    ...
    return (
      <div>
        <header class="body-font bg-purple-main text-gray-600">
          <div class="container mx-auto flex flex-col flex-wrap items-center pt-5 pl-7 lg:pl-0 md:flex-row">
            <a class="title-font mb-4 flex items-center font-medium text-gray-900 md:mb-0">
              ...
              <span class="ml-1 text-xl font-semibold">hDAO NFT Pocket Assistant</span>
            </a>
